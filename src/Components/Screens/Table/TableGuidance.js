...
function TableGuidance(action) {
  ...
  guidance.classList = "table-guidance-wrapper insulate wrap stack";

  /* html */
  guidance.innerHTML = `
    <div class="table-guidance-grid">
      <div class="table-guidance">
        ...
        <div class="table-example">
          ...
          <div class="table-caption">
            <p class="">Inter and Garamond have a 16% difference in x-height</p>
            <p class="">Inter and Mencken have matching x-heights</p>
          </div>
        </div>
      ...
      <div class="table-guidance">
        ...
        <div class="table-example">
          ...
          <div class="table-caption">
            <p class="">Mencken is 7% smaller than Inter so they do not align</p>
            <p class="">Inter and Mencken with aligned cap heights</p>
          </div>
        </div>
      ...
      <div class="table-guidance">
        ...
        <div class="table-example">
          ...
          <div class="table-caption">
            <p class="">Inter has a larger proporitons so has a wider line height</p>
            <p class="">Garamond has a smaller proportions so has a narrower line height</p>
          </div>
        </div>
  ...
  cta.appendChild(Button({label: "Hide Guidance", action: action}));
